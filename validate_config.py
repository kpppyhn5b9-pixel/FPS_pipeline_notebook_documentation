...
METRIQUES_VALIDES = {
    ...
    "C(t)", "E(t)", "L(t)", "fluidity", "dispersion_norm", "surprise_mean", "surprise_max", "attention_cons_share", "attention_anchor_share", "attention_garde", "innovation_cjs", "innovation_H", "effort_status",
