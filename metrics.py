...
COLUMN_LABELS = {
    ...
    'attention_salient_share': 'Attention (part de strates saillantes)',
    'attention_audibility':    'Attention (part de S portée par les saillantes)',
    'attention_garde':         'Attention (frein σ_Rloc)',
