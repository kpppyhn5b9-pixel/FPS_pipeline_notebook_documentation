...
> historique. **20/09 (suite)** : innovation = C_JS de l'enveloppe fₙ (plan H, C
> loggé), résilience = ralentissement critique (`compute_resilience_csd`), les
> §4.4 « couches empilées » n'existent plus.
